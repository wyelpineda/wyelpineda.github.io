...
<body>
            ...
            <div class="row" style="width: 100%;">
                <div class="col-lg-4 d-flex justify-content-center">
                    <a class="navbar-brand ms-5" href="#">
                        <img src="../img/PWlogo1.png" alt="Bootstrap" class="logo">
                    </a>
                </div>
                <div class="navlist col-lg-8 px-0 d-flex align-items-center justify-content-center">
                    <div class=" navmargin pt-1 " id="navbarNav" >
                    <ul class="nav nav-underline d-flex align-items-center justify-content-center " style="width:100%;">
    ...
    <!-- HOME -->
    <div class="one container-fluid position-relative" style="height: 100vh;">
        ...
        <div class="row position-relative" style="height: 100vh;">
            <div class="col-md-6" style="margin: auto 0 auto 0 ;" >
                ...
                <div class="col text-center mt-3">
                    <a href="#contacts" class="Pfv btn">Download CV</a>
                    <a href="#works" class="Ps btn">See My Works</a>
                </div>
            </div>
            <div class="col-md-6 d-flex align-items-end justify-content-center px-0 mx-0">
                <img src="img/pic4.png" alt=""class="me1" >
            </div>
        </div>
    </div>
    
    <!-- About -->
    <div class="aboutbg container-fluid position-relative" style="height: 100vh; "  id="about">
    <img src="img/bg/43.png" alt="" class="img4 position-absolute">
    <img src="img/bg/31.png" alt="" class="img8 position-absolute">
    <img src="img/bg/23.png" alt="" class="img9 position-absolute">
        <div class="row position-relative" style="height: 100vh;">
            <div class="col-md-6 d-flex align-items-end justify-content-center px-0 mx-0 ">
                <img src="img/pic1.png" alt="" class="me2" >
            </div>
    ...
    <div class="row skillrow position-relative">
            <div class="col-12 marg d-flex align-items-center justify-content-center">
                <p- class="skillsname text-dark">Skills</p>
            </div>
            <div class="col-md-2 mx-0 px-1 mt-2">
                <img src="img/1.png" alt="" class="skill" >
            </div>
            <div class="col-md-2 mx-0 px-1 mt-2">
                <img src="img/3.png" alt="" class="skill" >
            </div>
            <div class="col-md-2 mx-0 px-1 mt-2">
                <img src="img/5.png" alt="" class="skill" >
            </div>
            <div class="col-md-2 mx-0 px-1 mt-2">
                <img src="img/7.png" alt="" class="skill" >
            </div>
            <div class="col-md-2 mx-0 px-1 mt-2">
                <img src="img/9.png" alt="" class="skill" >
            </div>
            <div class="col-md-2 mx-0 px-1 mt-2">
                <img src="img/11.png" alt="" class="skill" >
            </div>
        </div>
    </div>
        ...
        <div class="row position-relative" style="height: 100vh;" >
                ...
                <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner" >
                        <div class="carousel-item active" data-bs-interval="10000">
                            <img src="img/fs.png" class="imgcarou d-block w-100" alt="...">
                            <div class="carousel-caption d-none d-md-block">
                                <h5 class="carou1 fw-bold">First Year Codings</h5>
                            </div>
                        </div>
                        <div class="carousel-item">
                            <img src="img/fs2.png" class="imgcarou d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="img/fs3.png" class="imgcarou d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="img/fs4.png" class="imgcarou d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="img/fs5.png" class="imgcarou d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item" data-bs-interval="2000">
                            <img src="img/fs1.png" class="imgcarou d-block w-100" alt="...">
                        </div>
                    </div>
            ...
            <div class="col-md-4 mx-0 work2">
                <div id="code" class="carousel carousel-dark slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active" data-bs-interval="10000">
                            <img src="img/stud.png" class="imgcarou d-block w-100" alt="...">
                            <div class="carousel-caption d-none d-md-block">
                                <h5 class="carou fw-bold">Current Codings</h5>
                            </div>
                        </div>
                        <div class="carousel-item" data-bs-interval="2000">
                            <img src="img/stud1.png" class="imgcarou d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="img/stud2.png" class="imgcarou d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="img/stud3.png" class="imgcarou d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="img/stud4.png" class="imgcarou d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="img/stud5.png" class="imgcarou d-block w-100" alt="...">
                        </div>
                    </div>
            ...
            <div class="col-md-3 mx-0 work1">
                <div id="images" class="carousel carousel-dark slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active" data-bs-interval="10000">
                            <img src="img/pz1.png" class="imgcarou d-block w-100" alt="..." >
                            <div class="carousel-caption d-none d-md-block">
                                <h5 class="carou fw-bold">Second Year Codings</h5>
                            </div>
                        </div>
                        <div class="carousel-item" data-bs-interval="2000">
                            <img src="img/pz2.png" class="imgcarou d-block w-100" alt="..." >
                        </div>
                        <div class="carousel-item">
                            <img src="img/pz3.png" class="imgcarou d-block w-100" alt="..." >
                        </div>
                        <div class="carousel-item">
                            <img src="img/pz4.png" class="imgcarou d-block w-100" alt="..." >
                        </div>
                        <div class="carousel-item">
                            <img src="img/pz5.png" class="imgcarou d-block w-100" alt="..." >
                        </div>
                        <div class="carousel-item">
                            <img src="img/pz6.png" class="imgcarou d-block w-100" alt="..." >
                        </div>
                        <div class="carousel-item">
                            <img src="img/pz7.png" class="imgcarou d-block w-100" alt="..." >
                        </div>
                    </div>
    ...
    <!-- Contacts -->
    <div class="contactsbg container-fluid position-relative" id="contacts">
    <img src="img/bg/35.png" alt="" class="img14 position-absolute">
    <img src="img/bg/39.png" alt="" class="img15 position-absolute">
        <div class="row position-relative" style="height: 100vh;" >
            <div class="col-12 d-flex align-items-center justify-content-center" >
                <p class="contactshead mb-0">Contacts</p>
            </div>
            <div class="col-md-6 d-flex align-items-center justify-content-center position-relative">
                <div class="row contactborder  position-relative">
            <img src="img/bg/53.png" alt="" class="img13 position-absolute">
                    <div class="col-12 d-flex align-items-center flex-column justify-content-center">
                        <p class="contactshname">Location</p>
                        <p class="contactsname text-center">San Agustin, San Miguel, Bulacan</p>
                    </div>
                    <div class="col-12 d-flex align-items-center flex-column justify-content-center">
                        <p class="contactshname">Email</p>
                        <p class="contactsname text-center">wyelpineda.basc@gmail.com</p>
                    </div>
                    <div class="col-12 d-flex align-items-center flex-column justify-content-center">
                        <p class="contactshname">Number</p>
                        <p class="contactsname text-center">09669907237</p>
                    </div>
                </div>
            </div>
            <div class="col-md-6" style="margin: auto;">
                <form action="">
                <div class="mb-3 text-center inputform">
                ...
                <div class="mb-3 text-center inputform">
                    ...
                    <input type="submit" class="contactbtn form-control" value="Contact Me">
                </form>
            </div>
        </div>
    </div>
